...
(function(){v.HYPE_780F=function(R,J,Oa,je,sj,tj,Va,A,lc,mq,pd,ef,fa,uj,Dg,ff,nq,oq,pq,ke){function gf(a){var b=zb(a);if(!(fa!=h||a==k||0<Ib||b==k||b.ob==h))if(b=b.Qa[M[a.id]],b!=k){var c=1==n(a,il,0),d=n(a,ql,0.5),e=n(a,rl,0.1),f=n(a,Vl,0.01);a=n(a,sl,0.001);0>=a&&(a=1E-6);c==h&&(d=0,e=1,a=Infinity);b.restitution=d;b.friction=e;b.frictionAir=f;c!=h&&B.Body.setDensity(b,a)}}function mc(a,b){var c,d,e,f=zb(a);if(!(fa!=h||a==k||0<Ib||f==k||f.ob==h)){var g=f.oa.world,j=M[a.id],m=f.Qa[j],l=n(a,il,0);
...
h||b.Oa==h)){b.Oa=h;var e=b.tc();if(e==k)d(b);else{-1==e[$b](ug)&&(e=Z+e+ug);var f=new XMLHttpRequest;f.open(Gh,e,h);f.responseType=Sk;f.onload=function(){b.Oa=p;b.Ba=h;b.Cb=f.response;a!=k&&a(b);b.$a==h&&b[ub]()};f.onerror=function(){b.Oa=p;d!=k&&d(b)};try{f.send()}catch(g){}}}};ra(b,function(){b.Mb();var a=v.HYPE_gac_780;a==k&&(a=new (v.AudioContext||v.webkitAudioContext),v.HYPE_gac_780=a);a.resume!=k&&a.resume();b.source=a.createBufferSource();b[Ac].connect(a.destination);ta(b[Ac],b.loop);b[xc].Fb==
...
rotateZ:{HYP_r:Ym,HYP_s:0},scaleX:{HYP_r:Tl,HYP_s:1},scaleY:{HYP_r:Ul,HYP_s:1},"z-index":{HYP_r:iq},opacity:{HYP_r:Nm,HYP_s:1}},rb=0,U=0,tb=[],Pb=[],sb={},cb={},Bd={},pc={},ha={},fh=p,Hd={},Zb=[],nh=p,aa={},gh={},ze=[],Jd={},ve=k,Bf=k,Yb={},M={},vh={},Ok=0,Ef=p,Nf=[],ah={},Ad={},Hk=p,Jc=p,lf=p,$g=p,te=[],Kc={},If={},rh={d:[[0,0,0.42,0,1,1,1,1]],e:[[0,0,0,0,0.58,1,1,1]],c:[[0,0,0.42,0,0.58,1,1,1]]},Id=p,sh=p,pe=v.HYPE_w_780,sf=[],th=p,zf=k;ca.xb=Tf;ca.wa=Qe;ca.pb=Mo;var Ae=p,Jf=0,Kf=p,ye=[];typeof String.prototype.trim!==
